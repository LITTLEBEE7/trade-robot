...
class BinanceTradeApi:
    ...
    # 多笔下单
    def multi_palce_order(self,exchange,symbol,type,side,amount,level,tdMode,price):
        # 撤销未完成的订单
        response = {
        "code":200,
        "msg":""
    ...
    # 多笔市价平仓
    def close_multi_positions(self,exchange,symbol,proportion):
        response = {
        "code":200,
        "msg":""
        }
        try:
            ...
            for pos in positions:
                ...
                logging.info(type(_amount))
                logging.info(_amount)
